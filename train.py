...
def config_mlflow():
    ...
    Returns:
        None
    """
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'olicrgarcia'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = '9919ceabde3d2ee08e803fd6851f9dab7cd3b1f2'
    mlflow.set_tracking_uri('https://dagshub.com/olicrgarcia/my-first-repo.mlflow/')
